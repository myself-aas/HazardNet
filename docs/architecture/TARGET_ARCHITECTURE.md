...
| Firestore remains adequate for forecasts | ADR 0014 supersedes the PostgreSQL forecast cutover; forecast writes require durable Firestore commits, with snapshots retained for degraded reads |

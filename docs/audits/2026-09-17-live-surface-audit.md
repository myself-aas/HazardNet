...
| SEC-09 | Authentication strength | 1 | 1 | Firebase Auth + Postgres JWT for AI routes, password-strength checks and a 5-lane rate-limit design are in place. Email verification / MFA enforcement could not be verified from outside; recommend confirming both in the console. **P1-3** |

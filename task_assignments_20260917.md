...
|---|---|---|---|---|---|---|
| TASK-001 | Derive split metadata; generate grouped_kfold + rolling_origin splits | ML/Data | data-agent | None | 4h | To Do |
...
| TASK-003 | Apply BD thresholds; 57/57 proofs in CI | ML | ml-agent | TASK-001 | 1h | To Do |
...
| TASK-008 | Claims registry CI gate | DevOps | devops-agent | None | 4h | To Do |
...
**Status logic:** all tasks To Do (no external blockers; every dependency is itself To Do).

...
export default tseslint.config(
  ...
  },
  {
    ...
    // `**/*.config.js` (not just root `*.config.js`): workspace config files
    // like `apps/windows/metro.config.js` (generated by `init-windows`, CommonJS)
    // are Node CJS too and must not lint as ESM modules (12 errors on a clean

...
export const DataProcessingSkeleton: React.FC<DataProcessingSkeletonProps> = ({
  ...
  return (
    <div
      className={`relative overflow-hidden border border-carbon-20 rounded-2xl bg-white/95 backdrop-blur-md shadow-xs flex flex-col justify-between transition-all duration-300 ${
        mode === 'full'
    ...
    >
      ...
      <div className="relative z-20 flex items-center justify-between border-b border-carbon-20 pb-3 mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          {onDismiss && (
            <button
              onClick={onDismiss}
              className="text-carbon-60 hover:text-carbon-90 bg-carbon-10 hover:bg-carbon-20 border border-carbon-20 px-2.5 py-1.5 rounded-lg text-xs font-bold transition-colors"
      ...
      <div className="relative z-20 flex-1 my-2 flex flex-col justify-center" aria-hidden="true">
        {!compact ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-full items-center">
            ...
            <div className="space-y-3 bg-carbon-05 p-3.5 rounded-xl border border-carbon-20 backdrop-blur-xs">
              <div className="flex items-center justify-between text-xs font-mono text-carbon-70 border-b border-carbon-20 pb-2 font-bold">
              ...
              <div className="space-y-2.5">
                {['Forecast snapshot', 'Map tiles', 'District layers'].map((label) => (
                  <div key={label}>
                    ...
                    <div className="w-full h-2 rounded-full bg-carbon-20 overflow-hidden border border-carbon-30">
                      <div className="h-full w-1/2 bg-carbon-40/70 cyber-skeleton-shimmer rounded-full" />
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                <div className="h-10 rounded-lg bg-white border border-carbon-20 p-2 flex flex-col justify-between cyber-skeleton-shimmer">
                  <div className="w-12 h-1.5 bg-carbon-20 rounded" />
                  <div className="w-20 h-2 bg-carbon-30 rounded" />
                </div>
                <div className="h-10 rounded-lg bg-white border border-carbon-20 p-2 flex flex-col justify-between cyber-skeleton-shimmer">
                  <div className="w-10 h-1.5 bg-carbon-20 rounded" />
                  <div className="w-16 h-2 bg-carbon-30 rounded" />
                </div>
              </div>
            </div>

            {/* Center: decorative radar sweep */}
            <div className="flex flex-col items-center justify-center p-4 bg-carbon-05 rounded-xl border border-carbon-20 relative min-h-[180px]">
              <div className="relative w-36 h-36 rounded-full border border-carbon-30 flex items-center justify-center bg-white shadow-xs">
                <div className="absolute inset-3 rounded-full border border-carbon-20" />
                <div className="absolute inset-7 rounded-full border border-carbon-20 border-dashed" />
                <div className="absolute inset-12 rounded-full border border-emerald-500/30" />

                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <div className="w-full h-[1px] bg-carbon-20" />
                  <div className="h-full w-[1px] bg-carbon-20 absolute" />
                </div>
            ...
            <div className="space-y-3 bg-carbon-05 p-3.5 rounded-xl border border-carbon-20 backdrop-blur-xs">
              <div className="flex items-center justify-between text-xs font-mono text-carbon-70 border-b border-carbon-20 pb-2 font-bold">
                ...
                <span className="text-carbon-60 font-mono font-bold">LOADING</span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {[...Array(6)].map((_, i) => (
                  ...
                  >
                    ...
                    <div className="w-full h-1 bg-carbon-30 rounded" />
                    <div className="w-2/3 h-1 bg-carbon-30/70 rounded" />
                  </div>
                ))}
              </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-3 py-6">
            <div className="relative w-16 h-16 rounded-full border border-carbon-30 flex items-center justify-center bg-carbon-05">
      ...
      <div className="relative z-20 pt-3 border-t border-carbon-20 flex flex-col sm:flex-row sm:items-center justify-between gap-2 font-mono text-[11px]">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div
            className="w-28 sm:w-36 h-2 rounded-full bg-carbon-20 border border-carbon-30 overflow-hidden"
            role="progressbar"

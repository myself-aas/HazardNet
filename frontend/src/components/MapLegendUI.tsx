        ...
        <div className="bg-white/95 border border-slate-200 rounded-2xl p-3 shadow-xl text-slate-800 text-xs flex flex-col gap-1.5">
          <div className="flex items-center justify-between gap-2 border-b border-slate-100 pb-1">
            ...
            <button
              ...
              className="w-11 h-11 rounded-full bg-slate-100 hover:bg-slate-200 active:bg-slate-300 text-slate-700 font-black flex items-center justify-center text-xs transition-colors cursor-pointer shrink-0 ml-2"
          ...
          <div className="flex items-center gap-1 text-xs font-mono">
            <span className="px-2 py-0.5 rounded bg-sky-500 text-slate-950 font-bold">20 dBZ Light</span>
            <span className="px-2 py-0.5 rounded bg-amber-500 text-slate-950 font-bold">38 dBZ Moderate</span>

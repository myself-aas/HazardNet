...
export function MenuCloseIcon({ size = 40, color = "currentColor", className, duration = 2000, isState }: StateIconProps) {
...
export function LockUnlockIcon({ size = 40, color = "currentColor", className, duration = 2600, isState }: StateIconProps) {
  const unlocked = useToggleState(duration, isState);
  return (
    <svg viewBox="0 0 40 40" fill="none" className={cn("", className)} style={{ width: size, height: size }}>
...
export function CopiedIcon({ size = 40, color = "currentColor", className, duration = 2200, isState }: StateIconProps) {

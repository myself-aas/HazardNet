...
export const About: React.FC = () => {
  return (
    <motion.div
      ...
      className="space-y-8 max-w-5xl mx-auto text-slate-800"
    >
      <Breadcrumbs />
      ...
      <motion.div
        ...
        className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 shadow-xs space-y-4"
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-slate-500 font-medium">Active Deployment: 2026</span>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 pt-2">
          <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
            <Link
              to="/use-cases"
              className="px-4 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold transition-all shadow-xs inline-block"
            >
          ...
          <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
            <a
              ...
              className="px-4 py-2 rounded-xl bg-slate-100 text-slate-700 text-xs font-bold border border-slate-200 hover:text-slate-900 hover:bg-slate-200 transition-all inline-block"
            >
              GitHub Repository
            </a>
          </motion.div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <motion.div
            ...
            className="bg-white border border-slate-200 p-5 rounded-2xl space-y-1 shadow-xs cursor-pointer"
          >
            <span className="text-[10px] font-mono uppercase text-slate-500 font-bold block">{stat.label}</span>
            <span className="text-xl font-extrabold text-slate-900">{stat.val}</span>
      ...
      <motion.div
        ...
        className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 space-y-6 shadow-xs"
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 text-xs">
          {[
            ...
            <motion.div
              key={i}
              whileHover={{ y: -2 }}
              className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-1 transition-all"
            >
              <h3 className="font-bold text-slate-900">{partner.name}</h3>
              <p className="text-slate-700 font-medium text-[11px]">{partner.role}</p>
              <p className="text-slate-500 text-[10px]">{partner.location}</p>
            </motion.div>
          ))}
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.4 }}
        className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 space-y-4 shadow-xs"
      >
        <h2 className="text-lg font-bold text-slate-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-slate-700">
          {[
            ...
            <motion.div
              ...
              className="bg-slate-50 border border-slate-200 p-4 rounded-xl space-y-2 transition-all"
            >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.4 }}
        className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 space-y-3 shadow-xs"
      >
        <h2 className="text-lg font-bold text-slate-900">
        ...
        <div className="p-4 bg-slate-900 text-slate-100 rounded-xl font-mono text-xs select-all overflow-x-auto border border-slate-800">
          {`# Clone the HazardNet GitHub Repository
git clone https://github.com/hazardnet/hazardnet-ai.git
cd hazardnet-ai

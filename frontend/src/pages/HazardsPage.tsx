          ...
          {hazardsList.map((hazard) => {
            ...
            return (
              <div
                ...
                className="bg-white border border-carbon-20 rounded-2xl p-6 hover:border-blue-400 hover:shadow-md transition-all cursor-pointer group flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-carbon-10 text-carbon-70">
